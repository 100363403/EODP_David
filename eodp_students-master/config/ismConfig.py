...
class ismConfig:
    ...
    def __init__(self):
        ...
        self.pix_size = 42e-6                       # Sentinel 3 data (E2E test)
        # self.t_int = 0.00672                      # [s] Integration time
        self.t_int = 0.0428                         # Sentinel 3 data (E2E test)

        # Optical system
        # self.D = 0.150                           # [m] Telescope pupil diameter
        self.D = 0.06575                           # Sentinel 3 data (E2E test)
        # self.f = 0.5262                          # [m] Focal length
        self.f = 0.2345                          # Sentinel 3 data (E2E test)
        ...
        self.apply_prnu = False             # Sentinel 3 configuration (E2E test)
        self.apply_dark_signal = False      # Sentinel 3 configuration (E2E test)
        self.apply_bad_dead = False         # Sentinel 3 configuration (E2E test)
