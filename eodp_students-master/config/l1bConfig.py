...
class l1bConfig:
    ...
    def __init__(self):
        ...
        self.do_equalization = False        # Sentinel 3 configuration  (E2E test)
        ...
        self.gain = np.array([0.005764054, 0.0042465106, 0.0032643573, 0.002987937])    # Sentinel 3 configuration  (E2E test)
