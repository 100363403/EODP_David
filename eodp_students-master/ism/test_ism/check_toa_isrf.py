...
print('Check error in Instrument Spectral Response Function:\n')

for band in gC.bands:
    toa_test = readToa(test_dir, gC.ism_toa_isrf + band + '.nc')
    toa_luss = readToa(luss_dir, gC.ism_toa_isrf + band + '.nc')
